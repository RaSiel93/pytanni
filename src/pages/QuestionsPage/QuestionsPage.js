  ...
  return (
    <div className='QuestionsPage'>
      <div>
        ...
        <ol>
          <li>Якія мэтады HTTP-запытаў самі знаеце?
          </li>
          <li>Якія вэрсіі HTTP-пратаколу вашэці вядомы?
          </li>
          <li>Якія знаеце коды адказу (стану) HTTP?
          </li>
          <li>Што такое Cross-Origin Resource Sharing? Як пазбавіцца праблем з CORS?
          </li>
          <li>Што такое cookie?
          </li>
          <li>Які максымальны памер cookie?
          </li>
          <li>Што азначае дырэктыва use strict?
          </li>
          <li>Чым JS адрозьніваецца падчас работы на front-end і back-end?
          </li>
          <li>Што такое статычная і дынамічная тыпізацыі?
          </li>
          <li>Як кліент узаемадзейнічае з сэрвэрам?
          </li>
          <li>Што такое REST?
          </li>
          <li>Патлумачце паняцьце мутабэльнасьць/імутабэльнасьць? Якія тыпы ёсьцека мутабэльнымі й наадварот?
          </li>
          <li>Як шукаць памылкі ў кодзе? Ці выкарыстоўваеце дэбагер?
          </li>
          <li>Якіх вядомых людзей са сьвету JS знаеце?
          </li>
        </ol>
        <p>
          <strong>JS Core:
        ...
        <ol>
          <li>Раскажыце пра піраміду тэставаньня.
          </li>
          <li>Якія тыпы аўтаматызаваных тэстаў выпадала нагода пісаць? Якія бібліятэкі пры гэтым выкарыстоўвалі? Якім інструмэнтам аддаеце перавагу й чаму?
          </li>
          <li>Што такое unit-тэсты? Якое мейсца ў пірамідзе тэставаньня займаюць unit-тэсты?
          </li>
          <li>Што такое code coverage? Ці абавязковае 100% пакрываньне тэстамі коду?
          </li>
          <li>Як забараніць браўзэру аддаваць кэш на HTTP-запыт?
          </li>
          <li>Што такое XSS (Cross-Site Scripting)?
          </li>
          <li>Раскажыце пра патэрны Observer, Pub/Sub. Якая паміж імі розьніца? Прывядзіце прыклады рэалізацы гэтых патэрнаў у вядомых хрэймворках/бібліятэках/браўзэрных API.
          </li>
          <li>Зь якою мэтаю можа быць выкарыстаны event listener падзеі fetch self.addEventListener(‘fetch’, event =&gt; {})?
          </li>
          <li>Што такое Event loop і як ён працуе? Раскажыце пра мікразадачы ды макразадачы.
          </li>
        </ol>
        <p>
          <strong>JS Core:
      ...
      <img alt="" class="cf tb tc" src="https://miro.medium.com/max/410/1*QzxqWt2lXjLt0hiJX6Q8PQ.png" width="410" height="29" loading="lazy" role="presentation"/>          </div>
        ...
        <ol>
          <li>Раскажыце пра хвункцанальнае праграмаваньне.
          </li>
          <li>Што такое TDD (Test Driven Development)/BDD (Behavior Driven Development)?
          </li>
          <li>Раскажыце дэталёва пра работу HTTPS.
          </li>
          <li>Які стэк тэхналёгіяў можна абраць для рэалізацы клону якога-небудзь вядомага праекту й чаму?
          </li>
          <li>Ёсьцека праект на старых тэхналёгіях, неабходна ў яго ўносіць зьмены. Як гэта зрабіць найлепш?
          </li>
          <li>Як кандыдат мае досьвед работы зь некалькімі хрэймворкамі: які выкарыстоўвацьмеце для наступнага праекту? Якія хвактары ўплывацьмуць на выбар?
          </li>
          <li>Што такое V8 Engine?
          </li>
        </ol>
        <p>
          <strong>JS Core:
